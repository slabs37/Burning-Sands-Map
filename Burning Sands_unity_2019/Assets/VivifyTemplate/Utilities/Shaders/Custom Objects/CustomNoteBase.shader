        ...
        */
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float edges = pow(dot(i.localPos, i.coord) + 0.7, 8);
                //float3 refl = sampleReflectionProbe(i.coord - nois.rrr).rgb;
                float3 refl = sampleReflectionProbe(rotatePoint(float3(0, 0, -1), -i.coord - nois.rrr)).rgb;
                return float4(Color * saturate(refl*0.5+0.3) * edges, 0);
