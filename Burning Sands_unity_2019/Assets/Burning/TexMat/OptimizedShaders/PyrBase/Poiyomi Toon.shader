Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/137705afe991e644b86abe4f19b7222b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				float3 heightOffset = (tex2Dlod(_VertexManipulationHeightMask, float4(poiUV(vertexUV(v, (0.0 /*_VertexManipulationHeightMaskUV*/)), float4(1,1,0,0)) + float4(0,0,0,0) * _Time.x, 0, 0))[(0.0 /*_VertexManipulationHeightMaskChannel*/)] - (0.5 /*_VertexManipulationHeightBias*/)) * ((0.25 /*_VertexManipulationHeight*/) + ALHeight) * o.normal;
				#else
				float3 heightOffset = ((0.25 /*_VertexManipulationHeight*/) + ALHeight) * o.normal;
				#endif
