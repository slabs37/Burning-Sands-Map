Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/6640d810438bf484b8abe95b92efbc12"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_VIDEOPIXELTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float3 pixels = tex2D(_VideoPixelTexture, poiUV(poiMesh.uv[(0.0 /*_VideoPixelTextureUV*/)], float4(0.1,0.1,0,0)) * float4(1280,720,0,0));
				#else
				float3 pixels = 1;
				#endif
				float2 uvs = poiMesh.uv[(0.0 /*_MainTexUV*/)];
