Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/605628b44ebf10d4e92370272fc4c499"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void CalculateUTSSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.636 /*_HighColor_Power*/)))) * (1.0 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.636 /*_HighColor_Power*/), 5)), (0.405 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/);
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if ((0.0 /*_Is_SpecularToHighColor*/))
						{
							vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.636 /*_HighColor_Power*/)))) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
						else
						{
							vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.636 /*_HighColor_Power*/), 5)), (0.405 /*_StylizedSpecularFeather*/)) * (1.0 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
