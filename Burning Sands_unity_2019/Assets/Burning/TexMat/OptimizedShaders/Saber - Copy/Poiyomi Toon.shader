Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/96fca85109c09e949805d7e3ac0a7ad9"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				for (uint glitterLayer = 0; glitterLayer < uint((2.0 /*_GlitterLayers*/)); glitterLayer++)
				{
					...
					half3 glitterColor = poiThemeColor(poiMods, float4(0.8103597,1,0,1).rgb, (0.0 /*_GlitterColorThemeIndex*/));
					...
					glitterMask *= float4(0.8103597,1,0,1).a;
			...
			void applySubsurfaceScattering(in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiFragData poiFragData)
			{
				...
				#endif
				#if defined(POINT) || defined(SPOT)
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(1,0,0,1) * SSS.rgb * lerp(1, poiFragData.baseColor, (0.0 /*_SSSBaseColorMix*/));
				#endif
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(1,0,0,1) * SSS.rgb * poiLight.attenuation * lerp(1, poiFragData.baseColor, (0.0 /*_SSSBaseColorMix*/));
			}
			#endif
			#ifdef POI_INTERNALPARALLAX
			...
			{
				float3 parallax = 0;
				for (int j = (4.0 /*_ParallaxInternalIterations*/) - 1; j >= 0; j--)
				{
					float ratio = saturate((float)j / max((4.0 /*_ParallaxInternalIterations*/) - 1, 1));
					float2 parallaxOffset = _Time.y * (float4(0.1,0.1,1,1) + ratio * float4(0,0,1,1));
					float fade = lerp((0.77 /*_ParallaxInternalMinFade*/), (0.0 /*_ParallaxInternalMaxFade*/), ratio);
					fade = pow(fade, 2.2);
					#if defined(PROP_PARALLAXINTERNALMAP) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					float3 minColor = poiThemeColor(poiMods, float4(0.2319224,0.2319224,0.2319224,1).rgb, (0.0 /*_ParallaxInternalMinColorThemeIndex*/));
					float3 maxColor = poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_ParallaxInternalMaxColorThemeIndex*/));
				...
				parallax = hueShift(parallax, frac((1.0 /*_ParallaxInternalHueShift*/) + (0.0 /*_ParallaxInternalHueShiftSpeed*/) * _Time.x) * (0.0 /*_ParallaxInternalHueShiftEnabled*/), (0.0 /*_ParallaxInternalHueShiftColorSpace*/), (1.0 /*_ParallaxInternalHueSelectOrShift*/));
				#if defined(PROP_PARALLAXINTERNALMAPMASK) || !defined(OPTIMIZER_ENABLED)
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0,0.341709,1,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0,0.341709,1,1).a;
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (0.5 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (0.492 /*_RimWidth*/), (1.0 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(1,0.8312811,0.0003650923,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftColorSpace*/), (1.0 /*_RimHueSelectOrShift*/), (0.0 /*_RimHueShiftSpeed*/),  (1.0 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (0.0 /*_RimBaseColorMix*/), (1.0 /*_RimBrightness*/), (4.0 /*_RimPoiBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
				#ifdef _SUNDISK_SIMPLE
