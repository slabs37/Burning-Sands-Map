    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 fragColor = float3(0.0, 0.5 - powA * 0.5, 0);
                ...
                //return float4(fragColor.yxz, opacityComplete*haloAlpha);
                return float4(fragColor.yxz * opacityComplete*haloAlpha, 0);
            }
            ENDCG
        }
    }
